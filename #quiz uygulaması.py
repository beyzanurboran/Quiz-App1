...
class Question:
    ...
    def checkAnswer(self,answer):
        if answer not in self.choices:
            raise ValueError(f"{answer} not found in choices")
...
class Quiz:
    ...
    def displayProgress(self):
        ...
        print(f"Toplam {totalQuestion} sorunun {questionNumber}. sorudasınız.".center(100, '*'))
        

q1 = Question("en iyi programlama dili hangisidir?",["python","c#", "java", "dart"], "python")
q2 = Question("en popüler programlama dili hangisidir?",["python","c#", "java", "dart"], "python")
q3 = Question("en çok kazandıran programlama dili hangisidir?",["python","c#", "java", "dart"], "python")
